...
import * as MyQNFT from '../../../build/contracts/MyNFT.json';
...
export class SondqNFTWrapper {
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(MyQNFT.abi as any) as any;
    }
